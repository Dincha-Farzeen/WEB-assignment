...
<body>
  ...
  <?php foreach ($photographers as $photographer): ?>
    ...
    <div style="margin: -80px 0 0 940px">
      <a class="contact-button" href="Photographer<?php echo htmlspecialchars($photographer['photographer_id']); ?>.php">Visit Photographer's Profile</a>
    </div>
  ...
  <footer class="footer">
    ...
    <div class="navigations">
      <div>NAVIGATIONS</div>
      <div style="margin-top: 5px;"><a href="about.html" style="text-decoration: none;
                color: white">About us</a>
      </div>
      <div style="margin-top: 5px;"><a href="contact.html" style="text-decoration: none;
                color: white">Contact Us</a>
      </div>
      <div style="margin-top: 5px;"><a href="termandcond.html" style="text-decoration: none;
